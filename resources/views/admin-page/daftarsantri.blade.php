                            ...
                            <tr>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                @if (isset($item['path_doc']) && isset($item['path_bill']))
                                                    <div class=" modal-footer">
                                                        <form action="{{ asset('admin/pendaftar') . '/' . $item['id'] }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('put')
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#delete{{ $item['no_regis'] }}">
                                        Delete
                                    </button>
                                    <div data-bs-backdrop="static" class="modal fade" id="delete{{ $item['no_regis'] }}"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class=" modal-footer">
                                                    <form action="{{ route('pendaftar.destroy', $item['id']) }}"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="btn btn-danger btn-sm d-inline-flex">Delete</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#detail{{ $item['no_regis'] }}">
                                        Detail
                                    </button>
                                    <!-- Modal Detail -->
                                    <div class="modal" id="detail{{ $item['no_regis'] }}" aria-labelledby="detailLabel"
                                        aria-hidden="true">
                                                    ...
                                                    <div class="" width="700px" style="margin-left:40px">
                                                        <div class="text-center mt-4">
                                                            <img width="115px" height="150px"
                                                                src="../storage/uploads/photo/{{ isset($item['path_photo']) ? $item['path_photo'] : 'user-icon.png' }}"
                                                                alt="">
                                                        </div>
                                                        <p class="fw-bold mt-4">Nomor Pendaftaran :
                                                            {{ $item['no_regis'] }}
                                                        </p>
                                                        <ol>
